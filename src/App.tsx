...
export default function App() {
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      ...
      const attempLimit = challenge.word.length + ATTEMPS_MARGIN
  ...
  return (
   <div className={styles.container}>
    <main>
      <Header current={lettersUsed.length} max={challenge.word.length + ATTEMPS_MARGIN} onRestart={handleRestartGame} />
